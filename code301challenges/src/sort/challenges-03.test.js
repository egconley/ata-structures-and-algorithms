...
const sortMeetingsByDay = (arr) => {
  arr.sort((a, b) => {
    if (a.dayOfWeek === 'Monday' && b.dayOfWeek !== 'Monday') {
      ...
      return 0;
    } else if (a.dayOfWeek !== 'Monday' && b.dayOfWeek === 'Monday') {
      console.log('return -1')
      return 1;
    } else if (a.dayOfWeek === 'Friday' && b.dayOfWeek !== 'Friday') {
      return 1;
    } else if (a.dayOfWeek !== 'Friday' && b.dayOfWeek === 'Friday') {
      return -1;
    } else if (a.dayOfWeek !== 'Monday' && b.dayOfWeek === 'Tuesday') {
      return 1;
    } else if (a.dayOfWeek !== 'Tuesday' && b.dayOfWeek === 'Wednesday') {
      return 1;
    } else {
      return 0;
    }
